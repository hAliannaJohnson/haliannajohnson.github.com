        ...
        */
        ...
        //Variable declared for Page focus on banner when loaded.
        ...
        function decisions() {
            ...
            //Page focus on banner when loaded.
            bannerFocus = document.getElementById("banner");
        ...
        function decisionOne() {
              if (document.getElementById("list-option-1").checked == true) {
               ...
               /*Background image added, centered and no repeat. Added color.
                ...
                chickenTier1 = "You have chosen to find the farmer’s chicken.  You know that the quest is too simple for a hero of your caliber, but you have had a rough couple of weeks and wanted a simple task to earn a few coppers.  The posting gives you directions to the farmer’s land and you choose to head out right after breakfast at the inn.  When you arrive, the farmer walks you over to the coop so that you may take a look around.  He provides you with a description of the chicken in question before heading back to his work.  You then proceed to looks for clues.";
         ...
         function decisionTwo(){
          ...
          function decisionTwoBrB(){
              if (document.getElementById("list-option-1").checked == true){
                chickenTier2 = "You begin your search by examining the area around the chicken coop. After walking around the its parameter, you notice a small bit of fabric hanging off a nail near the entrance.  The fabric scrap must have been ripped off the person's clothes that took the farmer's prized chicken.";
        ...
        //Branch A.
          ...
          function decisionThreeBrA1(){
              ...
              if (document.getElementById("list-option-1").checked == true){
                ...
                daughterTier3 = "You find a beautifully made but well used violin sitting on a stand near the window.  On closer examination you see that it has a broken string that needs to be replaced before she can play it again. You recall seeing an artisan in the village to the east that made instruments and decide to see if Emily went to get a new string. <p>When you arrive in the next village, you head straight to the artisan's shop.  When you arrive at the shop, he informs you that she has just left and was planning to stop at the local inn to eat before heading home.</p><p>You find Emily at the inn eating her meal.  Emily says that she left so quickly because she needed to get the string replaced immediately.  There is a village gathering in a few weeks at which she will be playing and needs to be able to practice.  She knew that there was an artisan in this village and so left as soon as she was ready to travel yesterday.  She had left her father a note knowing that she may not make it back that night for dinner, but it had been caught by a breeze and flew out an open window.  You escort her back to her father’s home and are rewarded with a few gold coins. </p>";
                document.getElementById("tier2").innerHTML = daughterTier3; 
          ...
          function decisionThreeBrA2(){
              ...
              if (document.getElementById("list-option-1").checked == true){
                ...
                daughterTier3 = "Eliza tells you that Emily has been feeding a stray dog that has been wondering around the village for a few weeks.  You asked around the village to see if anyone had seen the dog.  A farmer bringing in grain from his farm tells you that while he hasn’t seen the dog, he has seen Emily this morning.  She was heading out to the fields north of town.<p>Following his directions, you find her out in those fields walking back towards the village with a large black and white colored dog.  When you approach her, Emily tells you that she couldn’t find the stray dog where she usually fed him.  So, she went looking for him and spent all day looking everywhere.  Emily shares that she had just found the dog in the fields. You escort both her and her dog back to the mayor’s home.</p>";
                document.getElementById("tier3").innerHTML = daughterTier3; 
          ...
          function decisionThreeBrB1(){
              ...
              if (document.getElementById("list-option-1").checked == true){
                chickenTier3 = "The scrap is made of inexpensive materials and is also rough, quite dirty, and hints that the clothing is in disrepair. It strikes you that the state of the material is rougher than you have seen any of the villagers wearing and so it is likely to be from someone who is traveling through the area.  You ask around the village to find out if anyone has seen travelers recently that might be wearing clothing that would match the scrap you discovered.  Sara at the general store tells you that she has seen a band of people staying out in the valley to the south of the village by the waterfall. <p>You arrive at a vagabond's camp in the woods in time to see one of them pull a chicken off the fire that they have been roasting on a spit and start ripping it into hunks of meat to be passed around the fire.  You inquire with the person that cooked the chicken where it was that he found it.  He admits that they had taken it from a farmer's chicken coop nearby hoping he would not notice.  They were just so hungry when they stumbled upon the coop that they could not resist taking just one.</p> <p>Feeling bad for them, you chose not to turn them into the magistrate for stealing and instead suggest that they offer to trade a few days of work for food from the farmer.  They are hesitant at first of how the farmer will react to them after they stole his chicken, so you agree to broach the subject with the farmer yourself.  The farmer is devastated that his prized chicken is dead, but is willing to try out the trade of labor for a few days in order to get the harvest in on time for a festival the village is having next week.</p>";
                ...
                chickenTier3 = "The scrap is made of a rich fabric and has fine stitching making some type of flower pattern on it. You realize that the fabric matches that of a woman you saw eating at the inn when you went in to select a quest on the board.  The innkeeper, when questioned, informs you that it was Lady Beth that lives alone in a big home on the eastside of town.  As you walk up the lane to her home you hear a noise that sounded vaguely like a chicken but is so loud that it shakes the ground you are walking on.  As you come through the trees approaching the lady's home, you get your first look at the chicken as its head is poking over the top of the house.  It's now 50 feet tall.  <p>You stop in your tracks, so gob smacked that you are still standing there staring at the chicken when Lady Beth sees you through a window and comes out to greet you.  As it turns out, the lady is a witch and has decided to get back at the farmer for a passing comment he made by experimenting on his favorite chicken. </p><p>With the proof of the lady's power right in front of you, you realize that discretion is the better part of valor in resolving this situation.  You talk with her for several minutes and realize that she is generally not malicious, just angry at the farmer.  You get her to agree to return the chicken back to normal size if she receives an apology from the farmer.</p><p>The farmer is stubborn and does not want to apology to the essentric lady; however, you do convince he to come see the chicken for himself.  When you both arrive at Lady Beth's home, the farmer has much the same reaction to the size of his chicken as you do.  A bit more humbled, the farmer is quick to apology and the lady returns the chicken to normal size.</p>";
                document.getElementById("tier3").innerHTML = chickenTier3;
          ...
          function decisionThreeBrB2(){
              ...
              if (document.getElementById("list-option-1").checked == true){
                chickenTier3 = "On the side of the spyglass you see the logo of local shoppe that crafts toys for children.  Further examination of the spyglass confirms that it is a child's toy as it is simply made.  You surmise that it must have been left by a child playing in the area, but am not sure what that has to do with the chicken being missing.<p>You walk from farm to farm around the farmer's land looking to see if your hunch is right and some kids had been playing around the coop and perhaps had let the chicken get out of the pen the farmer had made around it. At the farm to the west, you hear some children playing behind the house.  As you come around the back of the house you find some boys pretending to rescue the chicken from bandits. The boys are rather chagrined, but agree that they should not have taken the chicken to play with.</p><p>You talk with the mother of the boy, whose house you find them at, and you both escort the boys back to the farmer's house where the chicken was taken from.  The boys apologize to the farmer and the boy's mother suggests that they do some work cleaning out the chicken coop for the farmer as punishment.  The farmer pays you for the trouble and seems pleased with getting a good story and work out of the trouble.</p>";
                document.getElementById("tier3").innerHTML = chickenTier3;
                ...
                chickenTier3 = "On the side of the spyglass you find a skull & crossbones scratched into the wood. You head to the Inn to speak with the Innkeeper to find out if any pirates have been seen in the area as you have seen markings like this on their possessions before.  The Innkeeper tells you that some hunters saw a ship in a cove near the docks with a pirate flag flapping from the top mast, the center pole of the ship.  When you arrive at the cove, you find that there is a ship present that has all the makings of a pirate's ship.  <p>You make your way as slowly and inconspicuously as you can down to the ship, as there may be several pirates present but only one of you.  </p><p> You end of having to fight your way onto a pirates’ ship to save the chicken wondering the whole time if this quest is worth the effort.  With luck, and quite a bit of skill, you manage to fight your way through the pirates on board and retrieve the chicken from their hold.</p><p>After returning to the deck with the chicken, you see another group of pirates blocking your path.  You prepare to battle them again but their captain has had enough.  He bargains to let you leave with the chicken as long as you allow them to retrieve the eggs from the wooden crate the chicken is in.  You retrieve the eggs and give them to the captain once you have made it to the beach, noting that they have a golden hue to their shells. </p> <p>You return the chicken to the farmer and he admits to you that the chicken does indeed lay golden eggs and gives you two as payment.";
                document.getElementById("tier3").innerHTML = chickenTier3;
